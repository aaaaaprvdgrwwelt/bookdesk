...
SVG = HIER.parent / "bookdesk" / "assets" / "bookdesk.svg"
...
def main() -> int:
    ...
    write_ico(ziel / "bookdesk.ico", ziel / "ico-teile")
    ordner = write_png_set(ziel / "bookdesk.iconset")
    print(f"geschrieben: {ziel / 'bookdesk.ico'}")
    print(f"geschrieben: {len(ordner)} PNGs in {ziel / 'bookdesk.iconset'}")
    print("Auf macOS daraus die .icns bauen:")
    print(f"  iconutil -c icns {ziel / 'bookdesk.iconset'}")
    return 0
